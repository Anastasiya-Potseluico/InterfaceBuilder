#ifndef GEOMETRICALPRIMITIVESCOLLECTOR_H
#define GEOMETRICALPRIMITIVESCOLLECTOR_H
#include <QList>
#include <QMap>
#include <QPoint>
...
class GeometricalPrimitivesCollector
{
public:
    GeometricalPrimitivesCollector();
    GeometricalPrimitivesCollector(QList<std::vector<cv::Point> >rectangles,
...
#endif // GeometricalPrimitivesCollector_H
