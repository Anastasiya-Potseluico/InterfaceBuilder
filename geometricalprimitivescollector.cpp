...
GeometricalPrimitivesCollector::GeometricalPrimitivesCollector()
{
...
GeometricalPrimitivesCollector::GeometricalPrimitivesCollector(QList<std::vector<cv::Point> >rectangles,
...
void GeometricalPrimitivesCollector::collectObjectsIntoWidgets()
{
    findRadioButtons();
...
AbstractWidget *GeometricalPrimitivesCollector::getMainWindow()
{
    return _mainWindow;
}

/* Метод для нахождения расположения одного контура в другом*/
FIGURE_LOCATION GeometricalPrimitivesCollector::getLocation(std::vector<cv::Point> &figureContainer,
...
bool GeometricalPrimitivesCollector::isInsideContour(const std::vector<cv::Point> &contourContainer, const std::vector<cv::Point> &checkingContour)
{
    int i;
    float distance;
...
bool GeometricalPrimitivesCollector::findPushButtons(std::vector<cv::Point> &buttonFrame,std::vector<cv::Point> &buttonInnerFigure)
{
...
bool GeometricalPrimitivesCollector::findRadioButtons()
{
    int i;
...
bool GeometricalPrimitivesCollector::findComboBoxes(std::vector<cv::Point> &buttonFrame,std::vector<cv::Point> &buttonInnerFigure)
{
     FIGURE_LOCATION currentLocation = getLocation(buttonFrame,buttonInnerFigure);
...
bool GeometricalPrimitivesCollector::findCheckBoxes(std::vector<cv::Point> &buttonFrame, std::vector<cv::Point> &buttonInnerFigure)
{
    FIGURE_LOCATION currentLocation = getLocation(buttonFrame, buttonInnerFigure);
...
bool GeometricalPrimitivesCollector::findLineEdits(std::vector<cv::Point> &buttonFrame, std::vector<cv::Point> &buttonInnerFigure)
{
    int lineEditCount;
    FIGURE_LOCATION currentLocation = getLocation(buttonFrame,buttonInnerFigure);
...
bool GeometricalPrimitivesCollector::findSpinBoxes(std::vector<cv::Point> &buttonFrame, QList<std::vector<cv::Point> > &buttonInnerFigures)
{
...
bool GeometricalPrimitivesCollector::findListWidgets(std::vector<cv::Point> &buttonFrame, QList<std::vector<cv::Point> > &buttonInnerFigures)
{
    FIGURE_LOCATION loc1 = getLocation(buttonFrame, buttonInnerFigures[0]);
    FIGURE_LOCATION loc2 = getLocation(buttonFrame, buttonInnerFigures[1]);
...
bool GeometricalPrimitivesCollector::findTreeWidgets(std::vector<cv::Point> &buttonFrame, QList<std::vector<cv::Point> > &buttonInnerRects, std::vector<cv::Point> &buttonInnerCircle)
{
...
bool GeometricalPrimitivesCollector::findTableWidgets(std::vector<cv::Point> &buttonFrame, QList<std::vector<cv::Point> > &buttonInnerFigures)
{
    FIGURE_LOCATION loc1 = getLocation(buttonFrame, buttonInnerFigures[0]);
    FIGURE_LOCATION loc2 = getLocation(buttonFrame, buttonInnerFigures[1]);
    FIGURE_LOCATION loc3 = getLocation(buttonFrame, buttonInnerFigures[2]);
...
bool GeometricalPrimitivesCollector::findLabels(std::vector<cv::Point> &buttonFrame, std::vector<cv::Point> &buttonInnerFigure)
{
    FIGURE_LOCATION currentLocation = getLocation(buttonFrame,buttonInnerFigure);
...
bool GeometricalPrimitivesCollector::findProgressBars(std::vector<cv::Point> &buttonFrame, QList<std::vector<cv::Point> > &buttonInnerFigures)
{
    FIGURE_LOCATION loc1 = getLocation(buttonFrame, buttonInnerFigures[0]);
    FIGURE_LOCATION loc2 = getLocation(buttonFrame, buttonInnerFigures[1]);
...
bool GeometricalPrimitivesCollector::findCalendars(std::vector<cv::Point> &buttonFrame, QList<std::vector<cv::Point> > &buttonInnerFigures)
{
    FIGURE_LOCATION loc1 = getLocation(buttonFrame, buttonInnerFigures[0]);
    FIGURE_LOCATION loc2 = getLocation(buttonFrame, buttonInnerFigures[1]);
    FIGURE_LOCATION loc3 = getLocation(buttonFrame, buttonInnerFigures[2]);
...
bool GeometricalPrimitivesCollector::findGraphicsViews(std::vector<cv::Point> &buttonFrame, std::vector<cv::Point> &buttonInnerFigure)
{
    FIGURE_LOCATION currentLocation = getLocation(buttonFrame, buttonInnerFigure);
    if(currentLocation == near_center
            || currentLocation == left_center
...
QList<std::vector<cv::Point> > GeometricalPrimitivesCollector::getInnerShapesList(std::vector<cv::Point> &contour, QList<std::vector<cv::Point> > & list)
{
    int i;
...
QPoint GeometricalPrimitivesCollector::findWidgetCenter(std::vector<cv::Point> &widgetFrame, FIGURE_NAME widgetType)
{
...
void GeometricalPrimitivesCollector::removeUsedGeometricalPrimitives(QList<std::vector<cv::Point> >&containerList, QList<std::vector<cv::Point> > &removedList)
{
